...
if($t_films == 0)
{
echo '<center><p style="font-size:30px;text-transform: uppercase;font-weight: 300;text-shadow: 0 2px 0 #000;color:white;margin-top:0%;">LA LISTE EST VIDE ... </p><br>
...
if($_GET['type'] != 'processed')
{
	echo '<p style="font-size:30px;text-transform: uppercase;font-weight: 300;text-shadow: 0 2px 0 #000;color:white;margin-bottom:2%;margin-left: 6%;"><i class="fa fa-eye"></i> En cours</p>';
}
...
echo ' <div style="display: block; clear: both;"></div><p style="font-size:30px;text-transform: uppercase;font-weight: 300;text-shadow: 0 2px 0 #000;color:white;margin-bottom:2%;margin-left: 6%;"><i class="fa fa-star"></i> Film à voir </p>';
// TEST
foreach ($films as $key => $film) 
{
	$id_movies = $film['id_movies'];
...
if($_GET['type'] != 'processed')
{
	echo ' <div style="display: block; clear: both;"></div><p style="font-size:30px;text-transform: uppercase;font-weight: 300;text-shadow: 0 2px 0 #000;color:white;margin-bottom:2%;margin-left: 6%;"><i class="fa fa-eye"></i> Films visionnés </p>';
}
foreach ($films as $key => $film) 
{
	$id_movies = $film['id_movies'];
