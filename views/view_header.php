	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
          ...
          <div class="col-md-2"><img src="theme/images/avatar.png" alt="">
              <center><a style="margin-top:5%;" href="#" class="btn btn-info"><i class="fa fa-star"></i>&nbsp;&nbsp;Utilisateur</a>&nbsp;&nbsp;</center></div>
  <div class="col-md-8">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Système TIMEFLIX</h4>
      </div>
      <div class="modal-body">
      <div class="list-group">
      <a href="#" class="list-group-item"><i class="profile-list-icon fa fa-dashboard"></i> Charge système <p style="float:right"><?php echo get_system(); ?> % </p></a>
	<a href="#" class="list-group-item"><i class="profile-list-icon fa fa-cog"></i> CORE_ENCODAGE<p style="float:right"><?php echo get_process('php index.php'); ?> </p></a>
...
<div id="main-navbar" class="navbar navbar-inverse" role="navigation">
		...
		<div class="navbar-inner">
			...
			<div class="navbar-header">
				<a href="<?php echo $url; ?>?view=goflix" class="navbar-brand"><?php echo $title; ?> <span class="label label-danger"><?php echo $revision; ?></a>
				</a>
			...
			<div id="main-navbar-collapse" class="collapse navbar-collapse main-navbar-collapse">
				<div>
	                             <ul class="nav navbar-nav">
	                             		<li>
						<a href="" data-toggle="modal" data-target="#info"><span class="mm-text"><i class="fa fa-shield"></i> Système</a>
						</li>
					</ul> 
