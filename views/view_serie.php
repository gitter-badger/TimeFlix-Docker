...
<p style="font-size:30px;text-transform: uppercase;font-weight: 300;text-shadow: 0 2px 0 #000;color:white;margin-bottom:2%;margin-left: 6%;"><i class="fa fa-star"></i> Vos favoris</p>
<?php 
if(!empty($list_id))
{
	foreach($serie as $key => $data_serie)
   {
	   	if(isset($list_id[$data_serie['id_serie_db']]))
	   	{
...
else
{
	...
	echo '<p style="font-size:30px;text-transform: uppercase;font-weight: 300;text-shadow: 0 2px 0 #000;color:white;margin-bottom:2%;margin-left: 6%;"><i class="fa fa-film"></i> Séries parcourus</p>';
}
